        ...
        this.$el.DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return (
                            '<a href="/EditQuaterForm/id=' + row.quaterId + '"class="btn mr-2 btn-edit btn-info btn-sm">' + '<i class="fa fa-pencil" aria-hidden="true"></i>' +
            ...
            <div>
                <div className="clearfix d-flex align-items-center row page-title">
                    ...
                    <div className="col text-right">
                        <Link to={{ pathname: '/add-quater', state: {} }} className="btn btn-primary"><i className="fa fa-plus" aria-hidden="true"></i></Link>
                    </div>
                    <button type="button"
